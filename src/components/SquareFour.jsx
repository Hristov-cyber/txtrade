...
import SideNavbarFour from './SideNavbarFour';
import TDMovieOut from "../assets/GoBlueGo.mp4";
...
<motion.div id='SquareFour' ref={targetRef} style={{ opacity, scale }}  className='perspective-100vw bg-black w-screen h-screen flex content-start justify-end items-start flex-col relative'>
  <section class="text-white-600 body-font z-30 flex h-full w-full ">
    <motion.div  className='hidden md:flex origin-right w-full h-full basis-0 z-30  '>  
      <SideNavbarFour className='z-40  '></SideNavbarFour>
    </motion.div>
  ...
  <div class="lg:w-4/6 mx-auto">
    ...
    <div class="flex flex-col sm:flex-row">
      ...
      <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-white-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
        ...
        <a class="self-center items-center whitespace-nowrap bg-transparent hover:bg-indigo-500 text-indigo-700 font-semibold hover:text-white py-2 px-1.5 border border-indigo-500 hover:border-transparent rounded inline-flex content-center">Contact us
